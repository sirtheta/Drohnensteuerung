...
Durch berechnen der Winkel mittels des Beschleunigungssensors konnten wir nun ziemlich genaue Resultate erzielen, solange der Arduino nicht bewegt wird.
In unserem definitiven Lösungsansatz haben wir dieses Problem wie folgt lösen können:\\
...
Diese Erkenntnis haben wir genutzt um eben dies zu bestimmen, so berechnen wir die Winkel anhand des Beschleunigungssensors nur, wenn dieser nicht künstlich beschleunigt wird.
